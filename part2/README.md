...
- **Haversine: Create CPU flamegraph** prompts for the pair count, reuses cached
  ...
  rendering. No extra profiler is needed. Perfetto span tracing is disabled during sampling.
...
validation are excluded. Tracing is disabled and the file cache may be warm.
